"""Stage 3 model: Modified 3D U-Net for per-vertebra binary segmentation."""
...
class ConvBlock3D(nn.Module):
    """Two consecutive Conv3d + LeakyReLU blocks."""
...
class UNet3D(nn.Module):
    ...
    Input:  [B, 2, 128, 128, 96]  (CT crop + Gaussian heatmap)
